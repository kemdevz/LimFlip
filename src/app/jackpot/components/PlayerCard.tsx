...
export default function PlayerCard({ username = 'jakep', avatarUrl, totalValue = 43800 }: PlayerCardProps) {
  return (
    <div
      style={{
        position: 'relative',
    ...
    >
      ...
      >
        ...
        />
        <img
          src={avatarUrl || "/assets/images/coinflip/item_1side.png"}
          alt="Avatar"
          style={{
            position: 'absolute',
            width: '84px',
