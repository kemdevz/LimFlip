    ...
    const fetchInventories = async () => {
      try {
        ...
        if (user?.id) {
          ...
          // Fetch user balance
          const userBalanceResponse = await fetch(`https://api-bash.onrender.com/auth/user/${user.id}`);
              ...
              >
                ...
                <div style={{ display: 'grid', placeItems: 'center', marginBottom: '0', position: 'relative', height: '400px', overflow: 'visible' }}>
                  ...
                  >
                    ...
                    {selectedDesiredItems && (selectedInputItems.length > 0 || balanceAmount.trim() !== '') && (
                      <svg
                        style={{
                          position: 'absolute',
                          zIndex: 10,
