            ...
            {!withdrawCrypto ? (
              ...
              <>
                ...
                >
                  ...
                  >
                    {[
                      { amount: '1,000', date: '10.7.24 9:26', currency: 'BTC', type: 'WITHDRAW', status: 'Pending' },
                      { amount: '500', date: '10.7.24 8:15', currency: 'BTC', type: 'WITHDRAW', status: 'Pending' },
                      { amount: '2,500', date: '10.6.24 14:30', currency: 'BTC', type: 'WITHDRAW', status: 'Pending' },
                    ].map((tx, index) => (
                      <div
                        key={index}
                        style={{
